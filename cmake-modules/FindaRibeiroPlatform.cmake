...
if(ARIBEIROPLATFORM_FOUND)
	if (NOT ${CMAKE_FIND_PACKAGE_NAME}_FIND_QUIETLY)
		MESSAGE(STATUS "Found aRibeiroCore include:  ${ARIBEIROPLATFORM_INCLUDE_DIR}/aRibeiroPlatform/aRibeiroPlatform.h")
		MESSAGE(STATUS "Found aRibeiroCore library: ${ARIBEIROPLATFORM_LIBRARIES}")
	endif()
else()
	if(${CMAKE_FIND_PACKAGE_NAME}_FIND_REQUIRED)
		MESSAGE(FATAL_ERROR "Could NOT find aRibeiroPlatform development files")
	endif()
endif()
